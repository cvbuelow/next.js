...
class FileSystemCache {
    ...
    async set(key, data, ctx) {
        ...
        if (data.kind === _responsecache.CachedRouteKind.REDIRECT) {
            // Delete existing data if it exists.
            const htmlPath = this.getFilePath(`${key}.html`, _responsecache.IncrementalCacheKind.PAGES);
        ...
        if (data.kind === _responsecache.CachedRouteKind.APP_ROUTE) {
            ...
            var _data_pageData_pageProps, _data_pageData;
            ...
            // @ts-ignore-next-line
            if (!isAppPath && ((_data_pageData = data.pageData) == null ? void 0 : (_data_pageData_pageProps = _data_pageData.pageProps) == null ? void 0 : _data_pageData_pageProps.forbidden)) {
                if (this.fs.existsSync(htmlPath)) {
                    await this.fs.unlink(htmlPath);
                }
            } else {
